...
namespace CustomMVVMDialogs
{
    ...
    public interface IDialogService
    {
        ...
        /// </returns>
        Task<ContentDialogResult> ShowContentDialogAsync<T>(INotifyPropertyChanged viewModel)
        ...
        /// <see cref="ContentDialogResult"/>.
        /// </returns>
        Task<ContentDialogResult> ShowCustomContentDialogAsync<T>(INotifyPropertyChanged viewModel)
        ...
        /// <see cref="ContentDialogResult"/>.
        /// </returns>
        Task<ContentDialogResult> ShowContentDialogAsync(INotifyPropertyChanged viewModel);
        ...
        /// </returns>
        Task<IUICommand> ShowMessageDialogAsync(
            string content,
            string title = null,
        ...
        /// </returns>
        Task<StorageFile> PickSingleFileAsync(FileOpenPickerSettings settings);
        ...
        /// </returns>
        Task<IReadOnlyList<StorageFile>> PickMultipleFilesAsync(FileOpenPickerSettings settings);
        ...
        /// </returns>
        Task<StorageFile> PickSaveFileAsync(FileSavePickerSettings settings);
        ...
        /// </returns>
        Task<StorageFolder> PickSingleFolderAsync(FolderPickerSettings settings);
    }
}