...
namespace CustomMVVMDialogs.FrameworkPickers.FileOpen
{
    /// <summary>
    ...
    internal sealed class FileOpenPickerWrapper
    {
        ...
        /// </returns>
        internal Task<StorageFile> PickSingleFileAsync() => picker.PickSingleFileAsync().AsTask();
        ...
        /// </returns>
        internal Task<IReadOnlyList<StorageFile>> PickMultipleFilesAsync() => picker.PickMultipleFilesAsync().AsTask();
    }
}
